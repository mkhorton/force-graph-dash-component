...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> force-graph -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import force-graph to your layout, then run it:
